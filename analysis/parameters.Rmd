...
```{r observed-mean-parameters , warning=FALSE, message=FALSE,echo=FALSE, fig.align="center", fig.height=6, fig.width=10}
...
```{r obs-vs-opt-mean-parameters, echo=FALSE, fig.align="center", fig.height=8, fig.width=10}
...
```{r observed-subject-parameters, warning=FALSE,message=FALSE,echo=FALSE, fig.align="center", fig.height=8, fig.width=10}
...
```{r observed-subject-gradients, warning=FALSE, message=FALSE,echo=FALSE, fig.align="center", fig.height=8, fig.width=10}
...
```{r observed-mean-gradient,warning=FALSE, message=FALSE,echo=FALSE, fig.align="center", fig.height=8, fig.width=10}
...
```{r max-gradients, echo=FALSE, warning=FALSE,message=FALSE,fig.align="center", fig.height=8, fig.width=10}
...
```{r observed-subject-surfaces,warning=FALSE, message=FALSE,echo=FALSE, fig.align="center", fig.height=8, fig.width=10}
...
```{r observed-gradient-parameters,warning=FALSE, message=FALSE,echo=FALSE, fig.align="center", fig.height=8, fig.width=10}
...
#   spread(key=parameter,value=value) %>%
#   group_by(subject,frame) %>%
#   summarise(w1_raw = mean((delta>=0)*w1 + (delta<0)*-w1),
#             delta_raw = mean(abs(delta)))
# 
# ggplot(data=means) +
#   geom_point(aes(x=w1_raw,y=delta_raw)) +
#   facet_grid(model~frame) +
#   labs(x="w1",y="delta")
