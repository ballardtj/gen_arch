...
for (goal_type in c('ap','av')){
  ...
  dataList=read_rdump(paste0('data/clean/opt_',goal_type,'_rdump_expt123.R'))

  load(paste0("data/derived/expt123_opt_",goal_type,"_fit.RData"))
...
for(i in 1:4){
  ...
  ggsave(file=paste0("figures/mean_gradients_opt",label,".pdf"),plot=figure,height=6,width=12)
