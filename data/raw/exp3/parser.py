...
# Command 1) cd 'directory', currently '/Users/timothyballard/Dropbox/Fun/Multiple-Goal Pursuit/B/Temporal/Data'
...
def main():
    ...
    parsed.write("goal_type,experimental_goal_height,experimental_start_height,experimental_weeks_total,"
                 ...
                 "trial_index_global,time_elapsed,internal_chunk_id,subject_id,gender_key,age,"
                 "session_key,birth_month,child_street,mothers_name,stage,left_current_height,"
    ...
    for file in os.listdir(data_location):
        ...
        if file[-4:] == ".csv":
            ...
            for line in data_file:
                ...
                # if "trial_index_global:3," in line_relevant:
                ...
                # if "trial_index_global:4," in line_relevant:
