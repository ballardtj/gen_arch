    ...
    plugin.trial = function(display_element, trial) {
            ...
            if (keyupevent.keyCode === scr.keyDown) {
                ...
                if (keyupevent.keyCode === 86) {
                    ...
                    if (scr.trialType === 'practice' && scr.preTrialScreen === 1) {
                        ...
                        ctx.lineWidth = 3;
                        ctx.font = "28px Times New Roman";
                        ctx.fillText("Here are the number of days", .18 * w, .53 * h, .32 * w);
        ...
        function initializeTrial(trial) {
            ...
            if (scr.experimentalWeeksTotal > scr.fixedWeeksTotal) {
                ...
                scr.fillerStartHeight = scr.fillerGoalHeight - 3 * (scr.experimentalWeeksTotal-scr.fixedWeeksTotal);
            }
            ...
            if (scr.experimentalWeeksTotal < scr.fixedWeeksTotal) {
                ...
                scr.fillerStartHeight = scr.fillerGoalHeight - 3 * (scr.fixedWeeksTotal-scr.experimentalWeeksTotal);         }
        ...
        function drawGoalDetails(canvas, ctx, scr) {
            ...
            ctx.fillText("Days Left in Growing Season", .18 * w, .13 * h, .30 * w);

            var centerX = .18 * w;
            var centerY = .32 * h;
            var rad = .0001 * w * h;
            var clockMax = 96;
            var clockNiches = 96/12;
            ...
            ctx.font = "24px Times New Roman";
            ctx.fillText("Days Left in Growing Season", .82 * w, .13 * h, .30 * w);
            ...
            var ceiling = 300; //top of scale
            var niches = 15; //number of intervals
            ...
            ctx.fillText('Treatment ' + (a+1), scaleCenter[a], .66 * h, .30 * w);
                ...
                if (a === 0){
                    ctx.fillStyle = scr.leftCropColor;
                    ctx.beginPath();
                    ctx.moveTo(scaleCenter[a]-barSpread/2 - normpdf(nicheCiel - nicheCiel*(1-scaleAbove0),scr.meanLeftGrowthGivenLeft,scr.sdLeftGrowthGivenLeft)*scaleWidth, scaleTop);
                    //ctx.fillStyle = "black";
                    for (var i = nicheCiel ; i > -1; i --) {    
                        ctx.lineTo(scaleCenter[a]-barSpread/2 - normpdf(i - nicheCiel*(1-scaleAbove0),scr.meanLeftGrowthGivenLeft,scr.sdLeftGrowthGivenLeft)*scaleWidth, scaleTop + scaleHeight - scaleHeight * i / nicheCiel);    
                    } 
                    ...
                    ctx.fillStyle = scr.rightCropColor;
                    ctx.beginPath();
                    ctx.moveTo(scaleCenter[a]+barSpread/2 - normpdf(nicheCiel - nicheCiel*(1-scaleAbove0),scr.meanRightGrowthGivenLeft,scr.sdRightGrowthGivenLeft)*scaleWidth, scaleTop);
                    //ctx.fillStyle = "black";
                    for (var i = nicheCiel ; i > -1; i --) {    
                        ctx.lineTo(scaleCenter[a]+barSpread/2 - normpdf(i - nicheCiel*(1-scaleAbove0),scr.meanRightGrowthGivenLeft,scr.sdRightGrowthGivenLeft)*scaleWidth, scaleTop + scaleHeight - scaleHeight * i / nicheCiel);    
                    } 
                ...
                if (scr.nActions===3 && a === 1){
                    ctx.fillStyle = scr.leftCropColor;
                    ctx.beginPath();
                    ctx.moveTo(scaleCenter[a]-barSpread/2 - normpdf(nicheCiel - nicheCiel*(1-scaleAbove0),scr.meanLeftGrowthGivenMiddle,scr.sdLeftGrowthGivenMiddle)*scaleWidth, scaleTop);
                    //ctx.fillStyle = "black";
                    for (var i = nicheCiel ; i > -1; i --) {    
                        ctx.lineTo(scaleCenter[a]-barSpread/2 - normpdf(i - nicheCiel*(1-scaleAbove0),scr.meanLeftGrowthGivenMiddle,scr.sdLeftGrowthGivenMiddle)*scaleWidth, scaleTop + scaleHeight - scaleHeight * i / nicheCiel);    
                    } 
                    ...
                    ctx.fillStyle = scr.rightCropColor;
                    ctx.beginPath();
                    ctx.moveTo(scaleCenter[a]+barSpread/2 - normpdf(nicheCiel - nicheCiel*(1-scaleAbove0),scr.meanRightGrowthGivenMiddle,scr.sdRightGrowthGivenMiddle)*scaleWidth, scaleTop);
                    //ctx.fillStyle = "black";
                    for (var i = nicheCiel ; i > -1; i --) {    
                        ctx.lineTo(scaleCenter[a]+barSpread/2 - normpdf(i - nicheCiel*(1-scaleAbove0),scr.meanRightGrowthGivenMiddle,scr.sdRightGrowthGivenMiddle)*scaleWidth, scaleTop + scaleHeight - scaleHeight * i / nicheCiel);    
                    } 
                ...
                if ( (scr.nActions===3 && a === 2) || (scr.nActions===2 && a === 1)  ) {
                    ...
                    ctx.fillStyle = scr.leftCropColor;
                    ctx.beginPath();
                    ctx.moveTo(scaleCenter[a]-barSpread/2 - normpdf(nicheCiel - nicheCiel*(1-scaleAbove0),scr.meanLeftGrowthGivenRight,scr.sdLeftGrowthGivenRight)*scaleWidth, scaleTop);
                    //ctx.fillStyle = "black";
                    for (var i = nicheCiel ; i > -1; i --) {    
                        ctx.lineTo(scaleCenter[a]-barSpread/2 - normpdf(i - nicheCiel*(1-scaleAbove0),scr.meanLeftGrowthGivenRight,scr.sdLeftGrowthGivenRight)*scaleWidth, scaleTop + scaleHeight - scaleHeight * i / nicheCiel);    
                    } 
                    ...
                    ctx.fillStyle = scr.rightCropColor;
                    ctx.beginPath();
                    ctx.moveTo(scaleCenter[a]+barSpread/2 - normpdf(nicheCiel - nicheCiel*(1-scaleAbove0),scr.meanRightGrowthGivenRight,scr.sdRightGrowthGivenRight)*scaleWidth, scaleTop);
                    //ctx.fillStyle = "black";
                    for (var i = nicheCiel ; i > -1; i --) {    
                        ctx.lineTo(scaleCenter[a]+barSpread/2 - normpdf(i - nicheCiel*(1-scaleAbove0),scr.meanRightGrowthGivenRight,scr.sdRightGrowthGivenRight)*scaleWidth, scaleTop + scaleHeight - scaleHeight * i / nicheCiel);    
                    } 
