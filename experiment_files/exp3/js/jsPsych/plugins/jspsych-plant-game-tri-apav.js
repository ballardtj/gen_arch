...
jsPsych['plant-game'] = (function() {
    ...
    plugin.create = function(params) {
        ...
        // trials[0].gender_key = params.gender_key;
        // trials[0].age  = params.age;
        // trials[0].session_key  = params.session_key;
        // trials[0].birth_month  = params.birth_month;
        // trials[0].child_street  = params.child_street;
        // trials[0].mothers_name  = params.mothers_name;
    ...
    plugin.trial = function(display_element, trial) {
        ...
        function initializeTrial(trial) {
            ...
            //For screenshot 1
            // scr.leftCropType = "WHEAT CROP";
            // scr.leftCropColor = "DARKGREEN";
            ...
            //     scr.goalType = 1;
            // scr.meanRightGrowthGivenRight = 20;
            //     scr.meanLeftGrowthGivenRight = 0;
            //     scr.meanRightGrowthGivenLeft = 0;
            //     scr.meanLeftGrowthGivenLeft = 20;
            //     scr.leftCropTypeShort = "WHEAT";
            //     scr.rightCropTypeShort = "RICE";  
            ...
            // //For screenshot 2
                ...
                // scr.leftStartHeight = 180;
                // scr.rightStartHeight = 160;
                // scr.leftWeeksTotal = 2;
                // scr.rightWeeksTotal = 4;
                // scr.goalType = 2;
                // scr.meanRightGrowthGivenRight = 0;
                // scr.meanLeftGrowthGivenRight = 20;
                // scr.meanRightGrowthGivenLeft = 20;
                // scr.meanLeftGrowthGivenLeft = 0;
                // scr.leftCropTypeShort = "NETTLE";
                // scr.rightCropTypeShort = "THISTLE";  
            ...
            // //For screenshot 3
                ...
                // scr.rightCropType = "RICE CROP";
                // scr.rightCropColor = "LIGHTSEAGREEN";
                // scr.leftStartHeight = 190;
                // scr.rightStartHeight = 120;
                // scr.leftWeeksTotal = 4;
                // scr.rightWeeksTotal = 4;
                // scr.goalType = 1;
                // scr.meanRightGrowthGivenRight = 20;
            ...
            // //For screenshot 3
                ...
                // scr.rightCropType = "WHEAT CROP";
                // scr.rightCropColor = "DARKGREEN";
                // scr.leftStartHeight = 160;
                // scr.rightStartHeight = 140;
                // scr.leftWeeksTotal = 2;
                // scr.rightWeeksTotal = 2;
                // scr.goalType = 1;
                // scr.meanRightGrowthGivenRight = 20;
            ...
            // //For screenshot 5
                ...
                // scr.rightCropType = "THISTLE WEED";
                // scr.rightCropColor = "SADDLEBROWN";
                // scr.leftStartHeight = 120;
                // scr.rightStartHeight = 190;
                // scr.leftWeeksTotal = 4;
                // scr.rightWeeksTotal = 4;
                // scr.goalType = 2;
                // scr.meanRightGrowthGivenRight = 0;
            ...
            // //For screenshot 6
                // scr.leftCropType = "LANTANA WEED";
                // scr.leftCropColor = "CORAL";
                // scr.rightCropType = "NETTLE WEED";
                // scr.rightCropColor = "GOLDENROD";
                // scr.leftStartHeight = 180;
                // scr.rightStartHeight = 160;
                // scr.leftWeeksTotal = 2;
                // scr.rightWeeksTotal = 2;
                ...
                // scr.meanRightGrowthGivenLeft = 20;
                // scr.meanLeftGrowthGivenLeft = 0;
                // scr.leftCropTypeShort = "LANTANA";
                // scr.rightCropTypeShort = "NETTLE";  
            

            // //For screenshot 7
                // scr.leftCropType = "RICE CROP";
                // scr.leftCropColor = "LIGHTSEAGREEN";
                // scr.rightCropType = "CORN CROP";
                // scr.rightCropColor = "YELLOWGREEN";
                // scr.leftStartHeight = 160;
                // scr.rightStartHeight = 160;
                // scr.leftWeeksTotal = 4;
                // scr.rightWeeksTotal = 2;
                ...
                // scr.meanRightGrowthGivenLeft = 0;
                // scr.meanLeftGrowthGivenLeft = 20;  
                // scr.leftCropTypeShort = "RICE";
                // scr.rightCropTypeShort = "CORN";
            ...
            //     scr.leftStartHeight = 180;
            //     scr.rightStartHeight = 180;
            //     scr.leftWeeksTotal = 1;
            //     scr.rightWeeksTotal = 8;
            //     scr.goalType = 1;
            //     scr.meanRightGrowthGivenRight = 20;
            //     scr.meanLeftGrowthGivenRight = 0;
            //     scr.meanRightGrowthGivenLeft = 0;
            ...
            // //For screenshot 10
             //    scr.leftCropType = "THISTLE WEED";
             //    scr.leftCropColor = "SADDLEBROWN";
             //    scr.rightCropType = "NETTLE WEED";
             //    scr.rightCropColor = "GOLDENROD";
             //    scr.leftStartHeight = 180;
             //    scr.rightStartHeight = 180;
             //    scr.leftWeeksTotal = 8;
             //    scr.rightWeeksTotal = 1;
             //    scr.goalType = 2;
             //    scr.meanRightGrowthGivenRight = 0;
             //    scr.meanLeftGrowthGivenRight = 20;
             //    scr.meanRightGrowthGivenLeft = 20;
             //    scr.meanLeftGrowthGivenLeft = 0;
             //        scr.leftCropTypeShort = "THISTLE";
             // scr.rightCropTypeShort = "NETTLE";
            ...
            // //For screenshot 13
              //   scr.leftCropType = "NETTLE WEED";
              //   scr.leftCropColor = "GOLDENROD";
              //   scr.rightCropType = "LANTANA WEED";
              //   scr.rightCropColor = "CORAL";
              //   scr.leftStartHeight = 180;
              //   scr.rightStartHeight = 160;
              //   scr.leftWeeksTotal = 8;
              //   scr.rightWeeksTotal = 1;
              ...
              //   scr.meanLeftGrowthGivenLeft = 0;
              //        scr.leftCropTypeShort = "NETTLE";
              // scr.rightCropTypeShort = "LANTANA";
            ...
            scr.trial_data = {
                ...
                // "gender_key": trial.gender_key,
                // "age": trial.age,
                // "session_key": trial.session_key,
                // "birth_month": trial.birth_month,
                // "child_street": trial.child_street,
                // "mothers_name": trial.mothers_name,
            };
        ...
        function allLoadedStartTrial() {
            ...
            //         keydupCallback(info,canvas,ctx,scr);
            //     }
