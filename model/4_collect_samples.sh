...
#model/goal sample num_samples=10 num_warmup=2 thin=1 id=$3 data file=model/$2_$1_rdump.R random seed=12345 output file=model/samples_$1_$2_$3.csv > model/output_$1_$2_$3.txt
