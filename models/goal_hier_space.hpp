...
namespace goal_hier_space_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model/goal_hier_space.stan");
    reader.add_event(186, 186, "end", "model/goal_hier_space.stan");
    return reader;
}
...
goal_sub(const T0__& w1_mean,
    ...
    try {
        ...
        validate_non_negative_index("dat", "2", 2);
        validate_non_negative_index("dat", "get_base1(Nobs,subj,\"Nobs\",1)", get_base1(Nobs,subj,"Nobs",1));
        Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  dat(static_cast<Eigen::VectorXd::Index>(2),static_cast<Eigen::VectorXd::Index>(get_base1(Nobs,subj,"Nobs",1)));
        (void) dat;  // dummy to suppress unused var warning

        stan::math::initialize(dat, DUMMY_VAR__);
        stan::math::fill(dat,DUMMY_VAR__);
        current_statement_begin__ = 45;
        validate_non_negative_index("weights", "2", 2);
        Eigen::Matrix<local_scalar_t__,1,Eigen::Dynamic>  weights(static_cast<Eigen::VectorXd::Index>(2));
        ...
        stan::math::assign(get_base1_lhs(weights,2,"weights",1), ((((w3_mean + (get_base1(w3,subj,"w3",1) * w3_sd)) * 2) * one_m_alpha_sub) * stan::math::sqrt((alpha_sub / one_m_alpha_sub))));
        current_statement_begin__ = 76;
        for (int obs = 1; obs <= get_base1(Nobs,subj,"Nobs",1); ++obs) {

            current_statement_begin__ = 77;
            stan::math::assign(a_stg, (1 / ((alpha_sub * get_base1(a_tod,obs,subj,"a_tod",1)) + (one_m_alpha_sub * get_base1(a_dot,obs,subj,"a_dot",1)))));
            current_statement_begin__ = 78;
            stan::math::assign(b_stg, (1 / ((alpha_sub * get_base1(b_tod,obs,subj,"b_tod",1)) + (one_m_alpha_sub * get_base1(b_dot,obs,subj,"b_dot",1)))));
            current_statement_begin__ = 79;
            stan::math::assign(get_base1_lhs(dat,2,obs,"dat",1), (a_stg - b_stg));
        }
...
struct goal_sub_functor__ {
    ...
    operator()(const T0__& w1_mean,
        ...
        return goal_sub(w1_mean, w1_sd, w1, w2_mean, w2_sd, w2, w3_mean, w3_sd, w3, delta, tau, alpha, Nobs, subj, expt, s1, s2, a_logd, b_logd, a_logt, b_logt, a_dot, b_dot, a_tod, b_tod, pstream__);
    }
};

class goal_hier_space_model : public prob_grad {
private:
    int Ntotal;
    int Nsubj;
    int Maxobs;
    ...
    int Nsubj2;
public:
    goal_hier_space_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "goal_hier_space_model_namespace::goal_hier_space_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(w3_sd, 0, 1));
            ...
            for (int subj = 1; subj <= Nsubj; ++subj) {
                ...
                stan::math::assign(p_a_logit, goal_sub(w1_mean,w1_sd,w1,w2_mean,w2_sd,w2,w3_mean,w3_sd,w3,delta,tau,alpha,Nobs,subj,expt,s1,s2,a_logd,b_logd,a_logt,b_logt,a_dot,b_dot,a_tod,b_tod, pstream__));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "goal_hier_space_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef goal_hier_space_model_namespace::goal_hier_space_model stan_model;
