...
namespace goal_fixed_space_expt123_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0993/models/goal_fixed_space_expt123_mpi.stan");
    reader.add_event(145, 143, "end", "/QRISdata/Q0993/models/goal_fixed_space_expt123_mpi.stan");
    return reader;
}
...
class goal_fixed_space_expt123_mpi_model : public prob_grad {
private:
    int Ntotal;
    int Nsubj;
    int Max_obs;
    ...
    int Nsubj_tg;
public:
    goal_fixed_space_expt123_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "goal_fixed_space_expt123_mpi_model_namespace::goal_fixed_space_expt123_mpi_model";
    ...
    ~goal_fixed_space_expt123_mpi_model() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "goal_fixed_space_expt123_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "goal_fixed_space_expt123_mpi_model";
    }
...
typedef goal_fixed_space_expt123_mpi_model_namespace::goal_fixed_space_expt123_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, goal_fixed_space_expt123_mpi_model_namespace::goal_sub_functor__)
