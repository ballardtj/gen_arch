...
namespace goal_fixed_space_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model/goal_fixed_space.stan");
    reader.add_event(139, 139, "end", "model/goal_fixed_space.stan");
    return reader;
}

template <typename T0__, typename T1__, typename T2__, typename T3__, typename T4__, typename T5__, typename T11__, typename T12__, typename T13__, typename T14__, typename T15__, typename T16__, typename T17__, typename T18__>
Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__, T5__, T11__, T12__, typename boost::math::tools::promote_args<T13__, T14__, T15__, T16__, typename boost::math::tools::promote_args<T17__, T18__>::type>::type>::type>::type, 1,Eigen::Dynamic>
goal_sub(const std::vector<T0__>& w1,
             const std::vector<T1__>& w2,
             const std::vector<T2__>& w3,
             const std::vector<T3__>& delta,
             const std::vector<T4__>& tau,
             ...
             const Eigen::Matrix<T11__, Eigen::Dynamic,Eigen::Dynamic>& a_logd,
             const Eigen::Matrix<T12__, Eigen::Dynamic,Eigen::Dynamic>& b_logd,
             const Eigen::Matrix<T13__, Eigen::Dynamic,Eigen::Dynamic>& a_logt,
             const Eigen::Matrix<T14__, Eigen::Dynamic,Eigen::Dynamic>& b_logt,
             const Eigen::Matrix<T15__, Eigen::Dynamic,Eigen::Dynamic>& a_dot,
             const Eigen::Matrix<T16__, Eigen::Dynamic,Eigen::Dynamic>& b_dot,
             const Eigen::Matrix<T17__, Eigen::Dynamic,Eigen::Dynamic>& a_tod,
             const Eigen::Matrix<T18__, Eigen::Dynamic,Eigen::Dynamic>& b_tod, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__, T5__, T11__, T12__, typename boost::math::tools::promote_args<T13__, T14__, T15__, T16__, typename boost::math::tools::promote_args<T17__, T18__>::type>::type>::type>::type local_scalar_t__;
    ...
    try {
        ...
        if (as_bool(logical_eq(get_base1(expt,subj,"expt",1),1))) {
            ...
            stan::math::assign(get_base1_lhs(weights,1,"weights",1), get_base1(w1,get_base1(s1,subj,"s1",1),"w1",1));
        ...
        if (as_bool(logical_eq(get_base1(expt,subj,"expt",1),2))) {
            ...
            stan::math::assign(get_base1_lhs(weights,1,"weights",1), get_base1(w2,get_base1(s2,subj,"s2",1),"w2",1));
        ...
        stan::math::assign(get_base1_lhs(weights,2,"weights",1), (((get_base1(w3,subj,"w3",1) * 2) * one_m_alpha_sub) * stan::math::sqrt((alpha_sub / one_m_alpha_sub))));
...
struct goal_sub_functor__ {
    template <typename T0__, typename T1__, typename T2__, typename T3__, typename T4__, typename T5__, typename T11__, typename T12__, typename T13__, typename T14__, typename T15__, typename T16__, typename T17__, typename T18__>
        Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__, T5__, T11__, T12__, typename boost::math::tools::promote_args<T13__, T14__, T15__, T16__, typename boost::math::tools::promote_args<T17__, T18__>::type>::type>::type>::type, 1,Eigen::Dynamic>
    operator()(const std::vector<T0__>& w1,
             const std::vector<T1__>& w2,
             const std::vector<T2__>& w3,
             const std::vector<T3__>& delta,
             const std::vector<T4__>& tau,
             ...
             const Eigen::Matrix<T16__, Eigen::Dynamic,Eigen::Dynamic>& b_dot,
             const Eigen::Matrix<T17__, Eigen::Dynamic,Eigen::Dynamic>& a_tod,
             const Eigen::Matrix<T18__, Eigen::Dynamic,Eigen::Dynamic>& b_tod, std::ostream* pstream__) const {
        return goal_sub(w1, w2, w3, delta, tau, alpha, Nobs, subj, expt, s1, s2, a_logd, b_logd, a_logt, b_logt, a_dot, b_dot, a_tod, b_tod, pstream__);
    }
};

class goal_fixed_space_model : public prob_grad {
private:
    int Ntotal;
    int Nsubj;
    int Maxobs;
    ...
    int Nsubj2;
public:
    goal_fixed_space_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "goal_fixed_space_model_namespace::goal_fixed_space_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int subj = 1; subj <= Nsubj; ++subj) {
                ...
                stan::math::assign(p_a_logit, goal_sub(w1,w2,w3,delta,tau,alpha,Nobs,subj,expt,s1,s2,a_logd,b_logd,a_logt,b_logt,a_dot,b_dot,a_tod,b_tod, pstream__));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "goal_fixed_space_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef goal_fixed_space_model_namespace::goal_fixed_space_model stan_model;
